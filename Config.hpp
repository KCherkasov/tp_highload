...
namespace config {
    ...
    // error messages 
    constexpr const char* UNKNOWN_KEY_ERROR = "Config file parsing error: unknown key: ";

    // default configuration values
    constexpr const char* DEFAULT_CONFIG_FILE_PATH = "/etc";

    constexpr const char* DEFAULT_ADDRESS = "0.0.0.0";
    constexpr const char* DEFAULT_ROOT_FOLDER = "/var/www/html";
    ...
    constexpr const char* DEFAULT_PROTOCOL = "HTTP/1.1";
